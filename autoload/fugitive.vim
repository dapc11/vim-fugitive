...
function! fugitive#MapJumps(...) abort
  if !&modifiable
    if get(b:, 'fugitive_type', '') ==# 'blob'
      ...
      call s:MapMotion('<up>', 'exe <SID>PreviousItem(v:count1)')
      call s:MapMotion('<down>', 'exe <SID>NextItem(v:count1)')
      call s:MapMotion('<left>', 'exe <SID>PreviousHunk(v:count1)')
      call s:MapMotion('<right>', 'exe <SID>NextHunk(v:count1)')
