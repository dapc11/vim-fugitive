...
function! fugitive#BufReadStatus(cmdbang) abort
  ...
  try
    ...
    call s:Map('n', "<tab>", ":<C-U>execute <SID>StageInline('toggle',line('.'),v:count)<CR>", '<silent>')
    ...
    call s:Map('x', "<tab>", ":<C-U>execute <SID>StageInline('toggle',line(\"'<\"),line(\"'>\")-line(\"'<\")+1)<CR>", '<silent>')
...
function! fugitive#MapJumps(...) abort
  if !&modifiable
    if get(b:, 'fugitive_type', '') ==# 'blob'
      ...
      call s:MapMotion('<C-up>', 'exe <SID>PreviousItem(v:count1)')
      call s:MapMotion('<C-down>', 'exe <SID>NextItem(v:count1)')
      call s:MapMotion('<C-left>', 'exe <SID>PreviousHunk(v:count1)')
      call s:MapMotion('<C-right>', 'exe <SID>NextHunk(v:count1)')
      call s:MapMotion('p', 'exe <SID>PreviousItem(v:count1)')
      call s:MapMotion('n', 'exe <SID>NextItem(v:count1)')
      ...
      call s:MapMotion('>i', 'exe <SID>PreviousItem(v:count1)')
      call s:MapMotion('<i', 'exe <SID>NextItem(v:count1)')
      call s:MapMotion('>c', 'exe <SID>PreviousHunk(v:count1)')
      call s:MapMotion('<c', 'exe <SID>NextHunk(v:count1)')
      call s:MapMotion('>f', 'exe <SID>PreviousFile(v:count1)')
      call s:MapMotion('<f', 'exe <SID>NextFile(v:count1)')
